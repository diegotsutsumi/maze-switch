...
typedef enum
{
	UI_BTN_FOOT_1_PRESSED,
	UI_BTN_FOOT_2_PRESSED,
	UI_BTN_FOOT_3_PRESSED,
	UI_BTN_FOOT_LEFT_PRESSED,
	UI_BTN_FOOT_RIGHT_PRESSED,
	UI_BTN_BUFFER_SWITCHED_ON,
	UI_BTN_BUFFER_SWITCHED_OFF,
	UI_BTN_SAVE_OK,
	UI_BTN_SAVE_CANCEL,
	UI_BTN_ERROR
}UI_BUTTON_ACTIONS;
...
typedef enum
{
	UI_BTN_LOCK, //External
	UI_BTN_RELEASE, //External
}UI_BUTTON_EVENTS;
